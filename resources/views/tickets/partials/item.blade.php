<div data-id="{{ $ticket->id }}" class="well well-sm ticket">
                    ...
                    @if (Auth::check())
                        <a href="#"
                        {!! Html::classes(['btn btn-primary btn-vote ', 'hidden' => currentUser()->hasVoted($ticket)]) !!} title="Votar por este tutorial">
                            <span class="glyphicon glyphicon-thumbs-up"></span> Votar
                        </a>
                        
                        <a href="#" 
                            {!! Html::classes(['btn btn-hight btn-unvote ', 'hidden' => !currentUser()->hasVoted($ticket)]) !!} title="Quitar el Voto por este tutorial">
                            <span class="glyphicon glyphicon-thumbs-down"></span> Quitar Voto
                        </a>
                    @endif    
                        <a href="{{ route('tickets.details', $ticket->getRouteKey()) }}">
